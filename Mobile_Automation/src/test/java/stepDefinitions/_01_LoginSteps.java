...
public class _01_LoginSteps {
    ...
    public void enterValidCredentialsAndClickLoginButton() {
        getAppiumDriver().findElement(loginPage.usernameInputField).sendKeys("demouser1@gmail.com");
        getAppiumDriver().findElement(loginPage.passwordInputField).sendKeys("demo123");
